    ...
    class main{
        public static void main(String[] args) {
           Patient patient = new Patient(); 
            ...
            Patient ob1 = new IndoorPaient("2020-094","david",1000, 800, 4000 ); 
             Patient ob2 = new IndoorPaient("2020-095","adam",2000, 900, 3000 ); 
           
           
            Patient ob3 = new OutdoorPatient("2020-096","maria", 800);
            Patient ob4 = new OutdoorPatient("2020-097","miller", 600);
